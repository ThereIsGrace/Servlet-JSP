...
.lst_type li{overflow:hidden; clear:both; margin: 10px 0 0; color:#2d2c2d; 'font-family:'돋움', Dotum; line-height:100px;
list_style: none; border-bottom: 2px solid lightgray;position:relative; }
