...
<body>
	...
	<fmt:formatDate value="${now }" type="date" dataStyle="full" /><br>
	...
	<br><br>
	한국 현재 시간:
	<fmt:formatDate value="${now }" type="both" dataStyle="full" timeStyle="full" /><br><br>
	
	<fmt:timeZone value="American/New York">
	뉴욕 현재 시간:
	<fmt:formatDate value="${now }"
		type="both" dataStyle="full" timeStyle="full" /><br>
	</fmt:timeZone>
</body>
</html>